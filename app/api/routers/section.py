...
from app.api.dependencies import CurrentUser, DBSession, OnlyAdmin, SectionEnrolledUser
...
async def get_lessons(section_id: int, _: SectionEnrolledUser, db: DBSession):
